...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.doodle_1);
        ...
        editTextNumber3 = findViewById(R.id.totalmoney);
        username = getIntent().getStringExtra("username");
        editTextNumber3.setText(String.valueOf(currentUser.getTotalCash()));
